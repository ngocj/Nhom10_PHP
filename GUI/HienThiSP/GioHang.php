...
global $conn;
$id=$tensp=$gia=$hinhanh=$soluong=0;
if (isset($_GET['id'])) {
    $id = $_GET['id'];
}
if (isset($_GET['tensp'])) {
...
if(!empty($tensp)&&!empty($gia)&&!empty($hinhanh)&&!empty($soluong)&&!empty($id)){
$sql2="INSERT INTO tbl_giohang VALUES ('','1','1','$tensp','$gia','$hinhanh','$soluong')";
$query2=$conn->query($sql2);
}
$sql3="SELECT * FROM tbl_giohang";
...
<div class="font-sans max-w-5xl max-md:max-w-xl mx-auto bg-white py-4">
            ...
            <div class="grid md:grid-cols-3 gap-8 mt-16">
                    ...
                    <div class="grid grid-cols-3 items-start gap-4">
                        ...
                        <div class="col-span-2 flex items-start gap-4">
                            ...
                            <div class="w-28 h-28 max-sm:w-24 max-sm:h-24 shrink-0 bg-gray-100 p-2 rounded-md">
                                <img src='../images/<?php echo $row3['hinhanh']?>' class="w-full h-full object-contain" />
                            </div>

                            <div class="flex flex-col">
                                <h3 class="text-base font-bold text-gray-800"><?= $row3['tensp']?></h3>
                                <p class="text-xs font-semibold text-gray-500 mt-0.5">Size: MD</p>

                                <a  href="Xoagh.php?id=<?= $row3['id_cart']?>" class="mt-6 font-semibold text-red-500 text-xs flex items-center gap-1 shrink-0">
                        ...
                        <div class="ml-auto">
                            <h4 class="text-lg max-sm:text-base font-bold text-gray-800"><?php echo $row3['giasanpham']?></h4>
                ...
                <div class="bg-gray-100 rounded-md p-4 h-max">
                    <h3 class="text-center text-lg max-sm:text-base font-bold text-gray-800 border-b border-gray-300 pb-2">Thông tin khách hàng</h3>
                    ...
                    <script>
                        function thongbao(){
                            alert("Bạn đã dat hang thanh cong");
                        }
                    </script>
                    <div class="mt-6 space-y-3">
                        <a href="dathang.php" onclick="return thongbao()">
                        <button  class="text-sm px-4 py-2.5 w-full font-semibold tracking-wide bg-gray-800 hover:bg-gray-900 text-white rounded-md">Mua hàng</button>
