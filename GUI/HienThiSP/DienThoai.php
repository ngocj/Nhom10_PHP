...
?>
    ...
    <h1 class="text-3xl font-bold text-gray-800 text-center -mt-4">Điện thoại</h1>
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mt-4">
            <?php
            // Truy vấn CSDL để lấy danh sách sản phẩm điện thoại từ danh mục có id_danhmuc = 2
            $sql = "SELECT * FROM tbl_sanpham INNER JOIN tbl_danhmuc ON tbl_sanpham.id_danhmuc=tbl_danhmuc.id_danhmuc WHERE tbl_sanpham.id_danhmuc = 2";
