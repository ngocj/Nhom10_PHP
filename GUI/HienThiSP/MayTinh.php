...
?>
    ...
    <h1 class="text-3xl font-bold text-gray-800 text-center -mt-4">Máy tính</h1>
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mt-4">
            <?php
            // Truy vấn CSDL để lấy danh sách sản phẩm điện thoại từ danh mục có id_danhmuc = 2
            $sql = "SELECT * FROM tbl_sanpham INNER JOIN tbl_danhmuc ON tbl_sanpham.id_danhmuc=tbl_danhmuc.id_danhmuc WHERE tbl_sanpham.id_danhmuc = 1";
            ...
            <div class="bg-white border border-gray-200 rounded-lg shadow-sm">
                ...
                <div class="p-4">
                    ...
                    <div class="flex justify-between items-center mt-4">
                        <span class="text-xl font-bold text-gray-900 dark:text-white"><?= $row["giasanpham"] ?>Đ</span>
